<div class="big_cadre">
    ...
    <table class="table">
      ...
      <tr>
        <td>
            <input name="medail1" type="checkbox" id="medail1" value="1" {M1} />
        </td>
        <td>
            <input name="medail2" type="checkbox" id="medail2" value="1" {M2} />
        </td>
        <td>
            <input name="medail3" type="checkbox" id="medail3" value="1" {M3} />
        </td>
        <td>
            <input name="medail4" type="checkbox" id="medail4" value="1" {M4} />
        </td>
        <td>
            <input name="medail5" type="checkbox" id="medail5" value="1" {M5} />
        </td>
      </tr>
      <tr class="table-titre">
        <td>6</td>
      ...
      <tr>
        <td>
            <input name="medail6" type="checkbox" id="medail6" value="1" {M6} />
        </td>
        <td>
            <input name="medail7" type="checkbox" id="medail7" value="1" {M7} />
        </td>
        <td>
            <input name="medail8" type="checkbox" id="medail8" value="1" {M8} />
        </td>
        <td>
            <input name="medail9" type="checkbox" id="medail9" value="1" {M9} />
        </td>
        <td>
            <input name="medail10" type="checkbox" id="medail10" value="1" {M10} />
        </td>
      </tr>
    </table>
