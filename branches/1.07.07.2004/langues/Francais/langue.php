...
$langue['where_news'] = "Regarde les news";
$langue['alert_affiche'] = "Les alertes du jour";
$langue['news_titre'] = "Les news";
...
$langue['where_defier'] = "proposer un match";
...
$langue['erreur_reaction_vide'] = "vous n'avez pas tapé votre réaction";
...
$langue['titre_reglement'] = "Le règlement du clan";
$langue['where_reglement'] = "Lit le règlement du clan";
...
$langue['titre_serveur_list'] = "Liste de serveur de jeux";
...
$langue['user_envois_newscodeok'] = "Votre nouveau code est validé, vous pouvez vous connecter avec";
$langue['user_envois_newscodeerror'] = "Le code que vous avez rentré n'est pas bon";
...
$langue['where_alert'] = "Edit les alertes";
$langue['titre_alert_gestion'] = "Gestion des alertes";
$langue['titre_alert_list'] = "Liste des alerts";
...
$langue['redirection_defit_add'] = "L'e-mail est envoyé, le match a été rajouté et la demande est surprimée, il faut regarder si il n'y a rien à changer dans la config du match !!!";
$langue['redirection_defit_dell'] = "La demande a été supprimée";
$langue['reponce_defit_oui'] = "Bonjour membre des %1\$s,\nVous nous avez proposé un match le %2\$s à %3\$s.\nNous y serons présents avec nos %4\$s joueurs comme prévu.\nAller alors rdv au match :-D\n\nA bientot, %5\$s (%6\$s) chargé des matchs";
$langue['reponce_defit_non'] = "Bonjour membre des %1\$s,\nVous nous avez proposé un match le %2\$s à %3\$s.\nNous ne savons nous présenter à ce match, pour diverses raisons, nous en sommes désolés\n\nA bientôt, %4\$s (%5\$s) chargé des matchs";
...
$langue['custom_menu_aide_defiler'] = "Option qui peut être désactivée sur certain thème, elle peut être activée mais il n\'aura aucune différence d\'affichage";

$langue['where_module'] = "Est dans l'administration des modules";
$langue['titre_module'] = "Édition des modules";
...
$langue['fichier_mosule'] = "Le module";
...
$langue['admin_mp3_source'] = "La URL du MP3";
...
$langue['titre_admin_news_gestion'] = "Gestion des news";
$langue['titre_admin_news_list'] = "La liste des news";
$langue['redirection_admin_news_add'] = "La news à ajouter";
$langue['redirection_admin_news_edit'] = "La news a été mise à jour";
$langue['redirection_admin_news_dell'] = "La news est bien supprimée";
...
$langue['erreur_msn_vide'] = "Vous n'avez pas entré votre Msn Messenger<br />";
$langue['erreur_msn_invalide'] = "Vous n'avez pas entré un e-mail valide pour votre Msn Messenger<br />";
