...
<div class="big_cadre">
	...
	<!-- BEGIN login -->
	<div id="login_bt">
	<div class="news"><a href="#showlogin" onClick="toggle_msg('login', '', '');toggle_msg('login_bt', '', '')">{login.LOGIN}</a></div>
		<p>
			<span><label for="nom">{login.FORM_NOM}&nbsp;:</label></span>
			<span><input name="nom_p" type="text" id="nom" value="{USER}" onBlur="formverif(this.id,'nbr','2')" /></span>
		</p>
		<p>
	...
	<a name="showlogin"></a><div id="login" style="display:none">
		<p>
