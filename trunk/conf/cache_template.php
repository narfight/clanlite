 ...
 *
 *   $Id: cache_template.php,v 1.1 2005/01/12 18:29:22 narfight Exp $
 *
 ***************************************************************************/
...
class Template {
	...
	function set_rootdir($dir)
	{
		...
		$this->root = $dir;
		$this->cachedir = $root_path.'cache/'.$config['skin'].'/';

		if (!file_exists($this->cachedir . 'modules/'))
		{
			@umask(0);
			...
			mkdir($this->cachedir . 'modules/', 0777);
		}
