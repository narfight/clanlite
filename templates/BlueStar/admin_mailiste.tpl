<div class="big_cadre">
	...
	<form method="post" action="mailiste.php">
		<p>
			<span><label for="section">{TXT_FOR}&nbsp;:</label></span>
			<span>
				<select name="section" id="section" onBlur="formverif(this.id,'change','-1')"> 
					<option value="0">{ALL_SECTION}</option> 
					<!-- BEGIN section --> 
		...
		<p>
			...
			<span><textarea name="corps" cols="40" rows="10" id="corps" onBlur="formverif(this.id,'nbr','10')"></textarea></span>
		</p>
		<p>
			<span><input type="submit" name="Envoyer" value="{ENVOYER}" /></span>
		</p>
	</form>
</div>